...
<<<< v3.6.1 >>>>
This version (3.6.1) is used for generating the results for the RFeditor manuscript submitted to BSSA in December 2015.

<<<< v3.7.0 >>>>
(1) Add option of sorting by event magnitude, read in from netmag table.
(2) Completely comment out LFC and dependency on GSL.
(3) Refine GUI labels for each editing procedure.
(4) Iterate on all stat-procedures including CORR, STW, RFQI.
