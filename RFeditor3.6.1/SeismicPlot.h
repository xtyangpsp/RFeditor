    ...
    public:
        ...
        */
        ...
        /*! Used internally to break the event loop.  
          ...
          This really shouldn't be in the public interface, but I couldn't figure out
        ...
        //back up original tse when call plot.
        //mainly used when restoreing the original ensemble.
        // added by Xiaotao Yang when developing TraceEditPlot.
        TimeSeriesEnsemble original_ensemble[3]; 
        //somehow, seisw plots a marker at time 0.0. this object is used
        //to reset the marker to the datarange.
        DisplayMarkerDataRec plotboxmarkers;
